...
use tree_builder::{IntendedParent, TreeBuilderOpts, TreeBuilder, TreeSink, create_element};
...
pub fn parse_fragment<Sink>(mut sink: Sink, opts: ParseOpts,
                            ...
                            -> Parser<Sink>
                            where Sink: TreeSink {
    let context_elem = create_element(&mut sink, context_name, context_attrs, IntendedParent::None);
