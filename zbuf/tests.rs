...
macro_rules! common_tests { ($Buf: ident) => {
    ...
    fn pop_front() {
        ...
        assert_eq!(mutated("abcdefghijklmnopqrstuvwxyz", |b| b.pop_front(20)).len(), 6);
    }
    ...
    fn pop_back() {
        ...
        assert_eq!(mutated("abcdefghijklmnopqrstuvwxyz", |b| b.pop_back(20)), "abcdef");
    }
    ...
    fn clear() {
        ...
        assert_eq!(mutated("abcde", |b| b.clear()).capacity(), inline_capacity());
        assert_eq!(mutated("abcdefghijklmnopqrstuvwxyz", |b| b.clear()), "");
        assert_eq!(mutated("abcdefghijklmnopqrstuvwxyz", |b| b.clear()).capacity(), 56);
    }
    ...
    fn truncate() {
        ...
        assert_eq!(mutated("1234567890123456", |b| b.truncate(100)), "1234567890123456");
    ...
    fn reserve() {
        ...
        assert_eq!(mutated("1234567890123456", |b| b.reserve(10)).capacity(), 56);
    }
...
mod bytes_buf {
    ...
    fn push_slice() {
        ...
        assert_eq!(mutated("1234567890", |b| b.push_slice(b"abcdefgh")), "1234567890abcdefgh");
        // Heap-allocated
        assert_eq!(mutated("1234567890123456", |b| b.push_slice(b"ab")), "1234567890123456ab");
